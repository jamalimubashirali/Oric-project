...
// console.log(token)
  useEffect(() => {
    const fetchRecords = async () => {
      try {
        const response = await axios.get('http://localhost:5000/api/submitform/userresearch-submissions', {
          headers: {
    ...
    <>
      <div className="flex max-w-full bg-white">
        ...
        <div className="mx-auto rounded-lg p-6 w-full">
          ...
          <h1 className="text-2xl font-bold text-primary-800 mb-6">My Research Excellence Records</h1>
          ...
          {loading ? (
            ...
            <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 text-blue-800">
              You haven't submitted any research excellence records yet.
            </div>
          ) : (
