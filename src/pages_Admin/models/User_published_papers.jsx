...
const partecular_Data=state.student.MyResearch

  useEffect(() => {
    const fetchRecords = async () => {
      try {
        console.log(partecular_Data)
        
        setRecords(partecular_Data);
        ...
        <div className="mx-auto rounded-lg p-6 w-full">
          ...
          {loading ? (
            ...
            <div className="space-y-4">
              {records?.map((record) => (
                <div key={record._id} className="border border-gray-200 rounded-lg overflow-hidden shadow-sm">
                   <div
...
export default User_published_papers;