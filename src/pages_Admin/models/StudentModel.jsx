...
const StudentModel = ({ setStudentmodel, student }) => {
  ...
  const handle_User_published=(student)=>{
    navigate(
      '/User_published_papers',
      {
        state: {
          student
        }
        ...
        >
          ...
          <div className="p-2 sm:p-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              />
              <InfoCard 
                icon={<PaperAirplaneIcon className="text-yellow-500" />}
                label="Published Papers" 
                value={student?.MyResearch?.length || 'None'} 
                onClicked={()=>{
                  handle_User_published(student),
...
const InfoCard = ({ onClicked,icon, label, value, valueColor = 'text-gray-700 dark:text-gray-300' }) => (
